...
namespace Luminasity
{
	...
	public class Icons
	{
		...
		public static void ExtractIcons(int first, int last, GameData gameData, bool fullImport, bool parallel)
		{
			...
			if (parallel)
			{
				...
				{
					ProcessIcon(directoryPath, fullImport, gameData, i);
				});
			} 
			else
			{
		...
		private static void ProcessIcon(string directoryPath, bool fullImport, GameData gameData, int i)
		{
